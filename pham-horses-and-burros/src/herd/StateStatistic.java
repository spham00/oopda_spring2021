...
public class StateStatistic extends Statistic {
	...
	/**
	 * Returns the fields of the StateStatistic as a String.
	 * @return	The fields of the state statistic as a String.
	 */
	public String toString() {
		return state + ", " + herdAreaAcresBLM + ", " + herdAreaAcresOther + ", " + herdManagementAreaAcresBLM 
