...
public class Simulator
{
    ...
    /**
     * Displays the number of counts for each animal in the simulation.
     */
    public void displayCounts() {
    	System.out.println("\nThe number of each animal:");
    	HashMap<Class, Counter> counter = view.getStats().getCounters();
    	for(Class key : counter.keySet()) {
    		System.out.println(key.getSimpleName() + ": " + counter.get(key).getCount());
    	}
    	System.out.println();
    }
